...
See also [the plugin README](https://github.com/impress/impress.js/tree/master/src/plugins/README.md) for documentation on `data-autoplay`.
...
**Note:** The introduction of the [rel](https://github.com/impress/impress.js/tree/master/src/plugins/rel/README.md) plugin includes a slight backward incompatible change.
...
By default the rotation order is `data-rotate-order="xyz"`. For some advanced uses you may need to change it. The demo presentation [3D rotations](https://github.com/impress/impress.js/tree/master/examples/3D-rotations/index.html) sets this attribute to rotate some steps into positions that are impossible to reach with the default order.
...
Many new features are implemented as plugins. The [Plugins documentation](https://github.com/impress/impress.js/tree/master/src/plugins/README.md) is the starting place to learn about those, as well as the README.md of [each plugin](https://github.com/impress/impress.js/tree/master/src/plugins/).
